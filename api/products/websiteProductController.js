...
const getWebsiteProductsBulk = asyncHandler(async (req, res) => {
  try {
    const pageSize = Number(process.env.LIMIT) || 10;
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
...
const getWebsiteProductsByCollection = asyncHandler(async (req, res) => {
  try {
    const pageSize = Number(process.env.LIMIT) || 10;
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
...
const getWebsiteProductsByCollectionHomepage = asyncHandler(
  async (req, res) => {
    try {
      const pageSize = Number(process.env.LIMIT) || 10;
      const page = Number(req.query.pageNumber) || 1;
...
const getWebsiteProductsByCategory = asyncHandler(async (req, res) => {
  try {
    const pageSize = Number(process.env.LIMIT) || 10;
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
...
const getWebsiteProductsByVendor = asyncHandler(async (req, res) => {
  try {
    const pageSize = Number(process.env.LIMIT) || 10;
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
...
const getWebsiteProductsBySubCategory = asyncHandler(async (req, res) => {
  try {
    const pageSize = Number(process.env.LIMIT) || 10;
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
...
const getWebsiteProductsBySubSubCategory = asyncHandler(async (req, res) => {
  try {
    const pageSize = Number(process.env.LIMIT) || 10;
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
...
const getWebsiteAllProducts = asyncHandler(async (req, res) => {
  try {
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
    searchParams['published_status'] = 'PUBLISHED';
...
const getWebsiteAllProductsSlug = asyncHandler(async (req, res) => {
  try {
    const page = Number(req.query.pageNumber) || 1;
    let searchParams = {};
    searchParams['published_status'] = 'PUBLISHED';
...
// @access  Public
const getWebsiteProductBySlug = asyncHandler(async (req, res) => {
  try {
...
// @access  Public
const getWebsiteProductById = asyncHandler(async (req, res) => {
  try {
    ...
    if (product && product.published_status === 'PUBLISHED' && product.vendor) {
      res.json(product);
    } else {
      res.status(404);
