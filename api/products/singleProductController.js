    ...
    pipeline.push({
      $project: {
        ...
        vendor: {
          ...
          store_name: '$vendorDetails.vendor.store_name',
          name: '$vendorDetails.name',
          phone: '$vendorDetails.phone',
          email: '$vendorDetails.email',
          address: { $arrayElemAt: ['$vendorDetails.vendor.pickup_address.address_1', 0] },
          city: { $arrayElemAt: ['$vendorDetails.vendor.pickup_address.city', 0] },
          state: { $arrayElemAt: ['$vendorDetails.vendor.pickup_address.state', 0] },
          pincode: { $arrayElemAt: ['$vendorDetails.vendor.pickup_address.pin', 0] },
          rating: '$vendorDetails.vendor.rating',
          service_areas: '$vendorDetails.vendor.service_areas',
          delivery_time: '$vendorDetails.vendor.delivery_time',
        },
        brand: {
