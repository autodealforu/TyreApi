...
export const FORGET_PASSWORD_TEMPLATE = ({ user, token }) => {
  ...
  <html>
    ...
    <body style="background-color: #f1f1f1">
      ...
      <div
        ...
        "
      >
      You have requested for password reset. Please click on the link below to reset password. 
      </div>
      <!-- end preheader -->
            ...
            >
              ...
              <tr>
                ...
                >
                  ...
                  <p>  <a target="_blank" href="${URI_SITE}reset-password/${token}"> Reset Password  </a> </p> 
